...
#          SPY.Equity = eqty, SPY.Drawdown = drawdn) |>
#   select(Date, SPY.Open, SPY.High, SPY.Low, SPY.Close,
...
highchart(type = "stock") |>
  ...
  hc_add_yAxis(nid = 1L, title = list(text = "Prices"), 
               relative = 3, type = "logarithmic") |>
  hc_add_series(chart_data[,7], yAxis = 1, name = "Equity", 
                color = "blue", type = "line") |>
  hc_add_series(xts(rep(10000, NROW(chart_data)), index(chart_data)), 
                yAxis = 1, name = "Initial", color = "black", type = "line") |>
