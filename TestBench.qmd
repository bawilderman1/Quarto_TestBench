...
highchart(type = "stock") |>
  ...
  hc_add_series(chart_data[,6], yAxis = 0, name = "Close Trade", 
  ...
  hc_add_series(chart_data[,8], yAxis = 2, name = "Drawdown", 
                ...
                tooltip = list(pointFormat = paste0("<span style=\"color:{series.color}\">●</span> {series.name}: <b>{point.y}%</b>"))
                ) |>
...
hchart(bt_metrics$data_trd, 
  ...
  hc_yAxis(title = list(text = "Max Trade Drawdown"),
           plotLines = list(
             list(dashStyle = "Dash", value = -0.11, color = "black", zIndex = 3)
           ))
```
