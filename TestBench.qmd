...
if (incl_buynhold) {
  bt_metrics <- append(bt_metrics, list(
    calc_bnh_cagr = bnh_cagr_val,
    calc_bnh_mar = bnh_mar_val,
    calc_bnh_calmar = bnh_calmar_val,
    calc_bnh_anlzd_sharp = bnh_anlzd_sharp_val
  ))
}
...
if (incl_buynhold) {
  print(glue(
    ...
    bnh_cagr = bt_metrics$calc_bnh_cagr))
  print(glue("Buy & Hold MAR: {bt_metrics$calc_bnh_mar}"))
  print(glue("Buy & Hold CALMAR: {bt_metrics$calc_bnh_calmar}"))
  print(glue("Buy & Hold Annualized Sharp: {bt_metrics$calc_bnh_anlzd_sharp}"))
}
```
...
bt_fmt_tbl <- tribble(
  ...
  "CAGR", "Summary Stats", bt_metrics$calc_cagr, NA, NA,
  "MAR", "Summary Stats", bt_metrics$calc_mar, NA, NA,
  "CALMAR", "Summary Stats", bt_metrics$calc_calmar, NA, NA,
  "Sharpe", "Summary Stats", bt_metrics$calc_sharp, NA, NA,
  "Ann. Sharpe", "Summary Stats", bt_metrics$calc_anlzd_sharp, NA, NA,
  ...
  "Time in Market", "Misc. Stats", bt_metrics$calc_time_in_mkt, NA, NA,
...
if (incl_buynhold) {
  bnh_list <- list(
    ...
    "Profit Factor" = NA,
    "CAGR" = bt_metrics$calc_bnh_cagr,
    "MAR" = bt_metrics$calc_bnh_mar,
    "CALMAR" = bt_metrics$calc_bnh_calmar,
    "Sharpe" = NA,
    "Ann. Sharpe" = bt_metrics$calc_bnh_anlzd_sharp,
    "Total Months" = NA,
    "Trade Months" = NA,
    "Time in Market" = NA,
