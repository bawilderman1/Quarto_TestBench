...
bt_ex_best3_tst <- data_ex_n_trds_func(
  bt_metrics$data_series,
  bt_metrics$data_trd,
  get_n_best_trades,
  3)

bt_ex_worst3_tst <-data_ex_n_trds_func(
  bt_metrics$data_series, 
  bt_metrics$data_trd, 
  get_n_worst_trades, 
  3)

# TODO: abstract trade data ex trades into yearly metrics and then annual calcs
# TODO: function to allow vector of trades to be removed i.e. C(1, 3)
# TODO: create gt for comparison of scenarios and add to bt_metrics as function
```
